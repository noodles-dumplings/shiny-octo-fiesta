...
https://github-cdn.vercel.app/noodles-dumplings/FreeD/master/tv/

https://github-cdn.vercel.app/noodles-dumplings/FreeD/latest/tv/

https://raw.fastgit.org/noodles-dumplings/FreeD/master/tv/

#### 接口使用说明

##### public.json  公共接口，会有些公共参数配置暂时用不到（通用）
##### searchUrl.json 搜索接口地址 对接苹果CMS10接口（通用）
##### webPlugNavigation.json  云插件接口（通用）<br>

##### sourceNavigation.json  TV资源专题接口<br>
